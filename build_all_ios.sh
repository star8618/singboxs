...
# 编译所有 iOS 架构的 sing-box 核心库
# 版本: v1.12.12

set -e

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
OUTPUT_DIR="${SCRIPT_DIR}/libbox_output"
VERSION="v1.12.12"

echo "=========================================="
echo "编译 sing-box iOS 核心库"
echo "版本: ${VERSION}"
...
# 编译 iOS 库（生产版本，包含所有架构）
echo ""
echo "📦 开始编译 iOS 库（arm64 + simulator arm64/x86_64）..."
cd "${SCRIPT_DIR}"
...
echo "build command: go run ./cmd/internal/build_libbox -target apple -platform ios" >> "${OUTPUT_DIR}/VERSION.txt"
