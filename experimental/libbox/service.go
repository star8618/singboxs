...
// 🔥 新增：节点切换回调
func (w *platformInterfaceWrapper) OnNodeSwitched(fromNode, toNode string) {
	w.iif.OnNodeSwitched(fromNode, toNode)
}

// 🔥 新增：所有节点失败回调
func (w *platformInterfaceWrapper) OnAllNodesFailed() {
	w.iif.OnAllNodesFailed()
}
